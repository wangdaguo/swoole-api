...
class Swoole
{
    ...
    private function __construct()
    {
        ...
        //将此目录作为App命名空间的根目录
        Swoole\Loader::addNameSpace('apps', self::$app_path);
    ...
    function runMVC()
    {
        ...
        if (isset($mvc['directory']))
        {
            ...
            $controller_class = '\\apps\\controllers\\' . $directory . '\\' . $controller_name;
            $controller_dir .= '/' . $directory;
        }
        else
        {
            $controller_class = '\\apps\\controllers\\' . $controller_name;
        }
        //控制器代码文件
