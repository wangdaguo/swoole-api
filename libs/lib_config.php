...
define("APPPATH", dirname(__DIR__). '/apps');
if (PHP_OS == 'WINNT')
{
    define("NL", "\r\n");
}
...
define("BL", "<br />" . NL);
// 加载配置文件
$envFile = dirname(__DIR__) . '/apps/configs/env.php';
if(file_exists($envFile))
{
    require_once $envFile;
}
!defined('DEBUG') && define('DEBUG', 'off');
...
//加载thrift
\Swoole\Loader::addNameSpace('Thrift', __dir__ . '/Thrift');
